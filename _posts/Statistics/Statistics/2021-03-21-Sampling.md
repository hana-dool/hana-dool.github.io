...
# [Sampling Methods](#link){: .btn .btn--primary}{: .align-center}
...
> ## 1.2 Requirements of Good sample 
...
8. Volunteer sample
   ...
   - 에브리타임에서도 소정의 돈을 주고 참가자들을 모집하는데, 이럴경우 부자인 사람들은 덜 Sampling 될 것이다. 이는 Biased 가 생긴것!
...
> ## 1.6 Sampling / Nonsampling error 
