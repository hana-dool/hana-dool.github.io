...
![png](/assets/images/Stat/112_1.png)
...
![png](/assets/images/Stat/112_2.png)
...
![png](/assets/images/Stat/112_3.png)
...
![png](/assets/images/Stat/112_4.png)

[![bias-variance2](https://user-images.githubusercontent.com/31824102/34830505-fae9a1b8-f6db-11e7-9933-c844c94fce25.PNG)](https://user-images.githubusercontent.com/31824102/34830505-fae9a1b8-f6db-11e7-9933-c844c94fce25.PNG)

> Truth model 이 비선형일 경우 

- 반대로 만약 실제의 $f$가 그 자체로 구불구불한 모양이 'truth'라면, 자연스레 더욱 flexible한 모델이 최적의 결과를 가져올 것이다.

![png](/assets/images/Stat/112_5.png)
...
![png](/assets/images/Stat/112_6.png)
...
- 대충 이러한 그림으로 나오는는데, 이는 $x_{1},x_{2}$가 주어지는 경우의 classification이다. 
  ...
  - 특정 input의 경우 100% 한 클래스에 속할수도 있겠지만(그림에서 맨 오른쪽, 혹은 맨 아래의 점들은 모두 파란색이므로 이때의 conditional probability $$ Pr(Y=파랑|X=x{0}) $$ 는 1이다.) 
- 애초에 모집단의 분포 자체가 섞여 있을 수도 있다(그림에서 정 중앙라인 부분). 그럴 경우 100% 그 클래스에 속하는 것은 아니고, 해당 경우 $$ Pr(Y=파랑|X=x{0}) $$ 는 1보다 작다.
...
![png](/assets/images/Stat/112_7.png)
...
![png](/assets/images/Stat/112_8.png)

[![KNN2](https://user-images.githubusercontent.com/31824102/34830551-24d023b2-f6dc-11e7-85ed-08f79d537363.PNG)](https://user-images.githubusercontent.com/31824102/34830551-24d023b2-f6dc-11e7-85ed-08f79d537363.PNG)
